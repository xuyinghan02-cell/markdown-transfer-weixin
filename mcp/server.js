  ...
  literary: {
    ...
    styles(v) {
      return {
        ...
        h4:          `display: block; font-size: ${v.fontSize + 1}px; font-weight: bold; color: #3d2b1f; margin: 18px 0 9px 0; line-height: 1.4;`,
        h5:          `display: block; font-size: ${v.fontSize}px; font-weight: bold; color: #5a4030; margin: 14px 0 7px 0; line-height: 1.4;`,
        h6:          `display: block; font-size: ${v.fontSize - 1}px; font-weight: bold; color: #8a6a5a; margin: 12px 0 6px 0; line-height: 1.4;`,
        ...
        inlineCode:  `background-color: #fdf6ee; padding: 2px 5px; border-radius: 3px; font-family: "SFMono-Regular", Consolas, monospace; font-size: 87%; color: ${v.accentColor};`,
        pre:         `display: block; background-color: #fdf6ee; border-radius: 6px; padding: 16px; margin: 16px 0; border-left: 4px solid ${v.accentColor}; overflow-x: auto;`,
        ...
        blockquote:  `display: block; border-left: 4px solid ${v.accentColor}; padding: 12px 20px; margin: 20px 0; background-color: #fdf6ee; color: ${v.mutedColor}; font-style: italic;`,
        ...
        td:          `border: 1px solid #e8d5c0; padding: 8px 12px; color: ${v.textColor};`,
      };
    },
  },
};
  ...
  tools: [
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          theme: {
            type: 'string',
            enum: ['default', 'tech', 'literary'],
            description: '排版主题：default（默认简洁）| tech（科技感）| literary（文艺清新）',
            default: 'default',
          },
          accent_color: {
            type: 'string',
